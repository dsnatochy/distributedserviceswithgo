...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	t.Helper()
	//l, err := net.Listen("tcp", ":0") // 0 automatically assigns a free port
	l, err := net.Listen("tcp", "127.0.0.1:63096") // 0 automatically assigns a free port
...
/*	clientOptions := []grpc.DialOption{grpc.WithInsecure()}
	...
	serverTLSConfig, err := config.SetupTLSConfig(
		config.TLSConfig{
			...
			Server: true, //TODO weird option name for client cert verification
		},
	)
	require.NoError(t, err)
